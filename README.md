...
MAPLE is a unified deep generative framework designed to resolve spatial tissue microenvironments by integrating spatial multi-omics with histology data.
